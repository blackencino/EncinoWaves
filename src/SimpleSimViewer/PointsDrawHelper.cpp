...
#include "PointsDrawHelper.h"

namespace EncinoWaves {
namespace SimpleSimViewer {

//-*****************************************************************************
PointsDrawHelper::PointsDrawHelper(bool i_dynamic, std::size_t i_numPoints,
  ...
  // OPENGL INIT
  //-*************************************************************************
  UtilGL::CheckErrors("point draw helper init before anything");
...
//-*****************************************************************************
void PointsDrawHelper::update(std::size_t i_numPoints, const V3f* i_vtxPosData,
