...
#ifndef _EncinoWaves_SimpleSimViewer_PointsDrawHelper_h_
#define _EncinoWaves_SimpleSimViewer_PointsDrawHelper_h_
...
public:
  PointsDrawHelper(bool i_dynamic, std::size_t i_numPoints,
